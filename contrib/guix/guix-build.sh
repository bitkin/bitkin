...
# Deterministically build Bitkincoin Core for HOSTs (overridable by environment)
...
for host in ${HOSTS=x86_64-linux-gnu arm-linux-gnueabihf aarch64-linux-gnu riscv64-linux-gnu x86_64-w64-mingw32}; do
    ...
    (
        ...
        #     same exact path (e.g. mapping '/home/satoshi/bitkincoin/' to
        #     '/home/satoshi/bitkincoin/'). This means that the $PWD inside the
        ...
        #                      according to SPEC
        #
        #   --share="$PWD"=/bitkincoin
        #
        #                     maps our current working directory to /bitkincoin
        ...
        #     container so that we have something to build. '/bitkincoin' was
        #     chosen arbitrarily.
        #
        ...
        time-machine environment --manifest="${PWD}/contrib/guix/manifest.scm" \
                                 ...
                                 -- env HOST="$host" \
                                      ...
                                      bash -c "cd /bitkincoin && bash contrib/guix/libexec/build.sh"
    )
