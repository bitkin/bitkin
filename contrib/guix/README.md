# Bootstrappable Bitkincoin Core Builds

This directory contains the files necessary to perform bootstrappable Bitkincoin
Core builds.
...
- 24GB of free disk space on the partition that the Bitkincoin Core git repository
  resides in
...
For a Bitkincoin Core depends development environment, simply invoke
...
From the top of a clean Bitkincoin Core repository:
...
To use dongcarl's substitute server for Bitkincoin Core builds after having
