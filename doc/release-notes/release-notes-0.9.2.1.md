Bitkincoin Core version 0.9.2.1 is now available from:

  https://bitkincoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BTK to 0.01 BTK
...
- Fix "Start bitkincoin on system login"
