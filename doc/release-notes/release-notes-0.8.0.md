Bitkincoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitkincoin/files/Bitkincoin/bitkincoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bitkincoin
...
New/changed settings (command-line or bitkincoin.conf file)
--------------------------------------------------------
