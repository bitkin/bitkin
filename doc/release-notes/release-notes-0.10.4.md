Bitkincoin Core version 0.10.4 is now available from:

  <https://bitkincoin.org/bin/bitkincoin-core-0.10.4/>
...
- #6953 `43c2789` Split bitkincoin-tx into its own package
- #6953 `dfe0d4d` Include bitkincoin-tx binary on Debian/Ubuntu
