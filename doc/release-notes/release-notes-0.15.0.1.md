Bitkincoin Core version *0.15.0.1* is now available from:

  <https://bitkincoin.org/bin/bitkincoin-core-0.15.0.1/>

and

  <https://bitkincoin.com/bin/bitkincoin-core-0.15.0.1/>
