Download URL: https://sourceforge.net/projects/bitkincoin/files/Bitkincoin/bitkincoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BTK fee schedule (users still pay 0.01 BTK per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitkincoin00 - #bitkincoin99
