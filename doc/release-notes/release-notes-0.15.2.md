Bitkincoin Core version *0.15.2* is now available from:

  <https://bitkincoin.com/bin/bitkincoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in bitkincoin-tx (TheBlueMatt)
