Bitkincoin Core version 0.9.4 is now available from:

  https://bitkincoin.org/bin/0.9.4/
...
this update is incompatible with the Bitkincoin system and could lead to consensus
forks.

Bitkincoin Core released binaries from https://bitkincoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitkincoin/+archive/ubuntu/bitkincoin
- A third-party or self-compiled Bitkincoin Core

upgrade to Bitkincoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
