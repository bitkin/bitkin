Bitkincoin Core version 0.13.2 is now available from:

  <https://bitkincoin.org/bin/bitkincoin-core-0.13.2/>
...
- #8908 `4a974b2` Update bitkincoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitkincoin-tx to create v2 transactions (btcdrak)
