Bitkincoin Core version 0.16.1 is now available from:

  <https://bitkincoin.com/bin/bitkincoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting bitkincoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bitkincoind processes are cleaned up when tests end (sdaftuar)
