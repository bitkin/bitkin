Bitkincoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitkincoin/files/Bitkincoin/bitkincoin-0.5.4/
...
http://gitorious.org/bitkincoin/bitkincoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bitkincoin-Qt notifications under Growl 1.3.
Increase required age of Bitkincoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitkincoin properly when installing Bitkincoin-Qt over it. (Windows)
