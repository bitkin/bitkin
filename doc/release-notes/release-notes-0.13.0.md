Bitkincoin Core version 0.13.0 is now available from:
...
bitkincoin-cli: arguments privacy
------------------------------
...
The two phases are distinct in the Bitkincoin-Qt GUI. During the first one,
