...
Bitkincoin Core version 0.19.1 is now available from:

  <https://bitkincoin.com/bin/bitkincoin-core-0.19.1/>
...
From Bitkincoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Bitkincoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Bitkincoin Core does not yet change appearance when
...
- #17488 fix "bitkincoind already running" warnings on macOS (fanquake)
