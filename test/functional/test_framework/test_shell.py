...
class TestShell:
    """Wrapper Class for BitkincoinTestFramework.

    The TestShell class extends the BitkincoinTestFramework
    ...
    class __TestShell(BitkincoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BitkincoinTestFramework child class.
            self.num_nodes = 1
