...
# Copyright (c) 2010-2020 The Bitkincoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test objects for interacting with a bitkincoind node over the p2p protocol.

The P2PInterface objects interact with the bitkincoind nodes under test using the
