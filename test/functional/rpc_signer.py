...
Verify that a bitkincoind node can use an external signer command.
...
class RPCSignerTest(BitkincoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart bitkincoind with -signer=<cmd>',
