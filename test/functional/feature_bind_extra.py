#!/usr/bin/env python3
# Copyright (c) 2014-2021 The Bitkincoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""
Test starting bitkincoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(BitkincoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that bitkincoind has bound on "::1" (for RPC) and "::" (for P2P).
