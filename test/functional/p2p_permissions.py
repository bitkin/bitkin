...
class P2PPermissionsTests(BitkincoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].bitkincoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].bitkincoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
