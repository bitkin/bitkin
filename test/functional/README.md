...
- The oldest supported Python version is specified in [doc/dependencies.md](/doc/dependencies.md).
  ...
  The Travis linter also checks this, but [possibly not in all cases](https://github.com/bitkin/bitkin/pull/14884#discussion_r239585126).
...
- Use a module-level docstring to describe what the test is testing, and how it
  is testing it.
- When subclassing the BitkincoinTestFramework, place overrides for the
...
The [`TestShell`](test-shell.md) class exposes the BitkincoinTestFramework
...
Test objects for interacting with a bitkincoind node over the p2p interface.
