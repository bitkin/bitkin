#!/usr/bin/env python3
# Copyright (c) 2020-2021 The Bitkincoin Core developers
...
class OrphanedBlockRewardTest(BitkincoinTestFramework):
    ...
    def run_test(self):
        ...
        # https://github.com/bitkincoin/bitkincoin/issues/14148.
