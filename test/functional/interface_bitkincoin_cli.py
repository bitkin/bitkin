...
# The block reward of coinbaseoutput.nValue (50) BTK/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 BTK/block.
BLOCKS = 101
...
class TestBitkincoinCli(BitkincoinTestFramework):
    ...
    def run_test(self):
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and bitkincoin-cli getwalletinfo return expected wallet info")
            ...
            # Mine a block to confirm; adds a block reward (50 BTK) to the default wallet.
            ...
            # Test bitkincoin-cli -generate with -rpcwallet in multiwallet mode.
