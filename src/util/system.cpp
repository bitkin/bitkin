 ...
 * https://github.com/bitkin/bitkin/pull/16097#issuecomment-514627823
 */
...
bool ArgsManager::ParseParameters(int argc, const char* const argv[], std::string& error)
{
    ...
    for (int i = 1; i < argc; i++) {
        ...
        if (key == "-") break; //bitkincoin-tx using stdin
        std::string val;
...
{
    // Windows: C:\Users\Username\AppData\Roaming\Bitkincoin
    // macOS: ~/Library/Application Support/Bitkincoin
    // Unix-like: ~/.bitkincoin
#ifdef WIN32
    // Windows
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    std::string strCopyrightHolders = "Copyright (C) 2021 " + copyright_devs;
