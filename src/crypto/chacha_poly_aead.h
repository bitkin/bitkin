...
/* A AEAD class for ChaCha20-Poly1305@bitkincoin.
 *
 ...
 *
 * The chacha20-poly1305@bitkincoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bitkincoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bitkincoin are relatively fast in
