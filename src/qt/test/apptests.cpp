...
//! Entry point for BitkincoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BitkincoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BitkincoinGUI tests.
void AppTests::guiTests(BitkincoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BitkincoinGUI::consoleShown, this, &AppTests::consoleTests);
