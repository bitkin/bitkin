    ...
    mapper(nullptr)
{
    ...
    ui->bitkincoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bitkincoinAtStartup);
    ...
    ui->bitkincoinAtStartup->setToolTip(ui->bitkincoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bitkincoinAtStartup->setText(ui->bitkincoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openBitkincoinConfButton->setToolTip(ui->openBitkincoinConfButton->toolTip().arg(PACKAGE_NAME));
