...
bool MemPoolAccept::PreChecks(ATMPArgs& args, Workspace& ws)
{
    ...
    if (!m_pool.CalculateMemPoolAncestors(*entry, setAncestors, m_limit_ancestors, m_limit_ancestor_size, m_limit_descendants, m_limit_descendant_size, errString)) {
        ...
        // this, see https://lists.linuxfoundation.org/pipermail/bitkincoin-dev/2018-November/016518.html
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    else if(nHeight >= 95300 && nHeight <= 125300)
    {
       if(nHeight%100==0)
       nSubsidy = 50000 * COIN;
       else
    ...
    else if(nHeight <= 480400)
    {
       nSubsidy = 25 * COIN;
    }
    else if(nHeight <= 830800)
    {
       nSubsidy = 12.5 * COIN;
    }
    else if(nHeight <= 1181200)
    {
       nSubsidy = 6.25 * COIN;
    }
    else if(nHeight <= 2184416)
    {
       nSubsidy = 3.125 * COIN;
    }
