...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Bitkincoin
else
  DOCKER_EXEC echo \> \$HOME/.bitkincoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/bitkin/bitkin/pull/18288#discussion_r433189350 for
  # details.
