...
First, in terms of structure, there is no particular concept of "Bitkincoin Core
...
Before you start contributing, familiarize yourself with the Bitkincoin Core build
system and tests. Refer to the documentation in the repository on how to build
Bitkincoin Core and how to run the unit tests, functional tests, and fuzz tests.

There are many open issues of varying difficulty waiting to be fixed.
If you're looking for somewhere to start contributing, check out the
[good first issue](https://github.com/bitkin/bitkin/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/bitkin/bitkin/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
Some of them might no longer be applicable. So if you are interested, but
unsure, you might want to leave a comment on the issue first.

You may also participate in the weekly
[Bitkincoin Core PR Review Club](https://bitkincoincore.reviews/) meeting.
...
on [http://www.erisian.com.au/bitkincoin-core-dev/](http://www.erisian.com.au/bitkincoin-core-dev/)
and [http://gnusha.org/bitkincoin-core-dev/](http://gnusha.org/bitkincoin-core-dev/).
...
For GUI-related issues or pull requests, the https://github.com/bitkincoin-core/gui repository should be used.
For all other issues and pull requests, the https://github.com/bitkin/bitkin node repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to bitkincoin-qt
...
fork of Bitkincoin Core copies the merge. Instead, make any username mentions in a
subsequent comment to the PR.

### Translation changes

Note that translations should not be submitted as pull requests. Please see
[Translation Process](https://github.com/bitkin/bitkin/blob/master/doc/translation_process.md)
...
https://github.com/bitkin/bitkin/pull/16189).

Also see the [backport.py script](
https://github.com/bitkincoin-core/bitkincoin-maintainer-tools#backport).
