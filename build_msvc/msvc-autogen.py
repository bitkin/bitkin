...
libs = [
    'libbitkincoin_cli',
    'libbitkincoin_common',
    'libbitkincoin_crypto',
    'libbitkincoin_server',
    'libbitkincoin_util',
    'libbitkincoin_wallet_tool',
    'libbitkincoin_wallet',
    'libbitkincoin_zmq',
    'bench_bitkincoin',
    'libtest_util',
]
...
def main():
    parser = argparse.ArgumentParser(description='Bitkincoin-core msbuild configuration initialiser.')
        ...
        with open(vcxproj_filename + '.in', 'r', encoding='utf-8') as vcxproj_in_file:
            with open(vcxproj_filename, 'w', encoding='utf-8') as vcxproj_file:
                vcxproj_file.write(vcxproj_in_file.read().replace(
                    '@SOURCE_FILES@\n', content))
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/bitkincoin_config.h'), os.path.join(SOURCE_DIR, 'config/bitkincoin-config.h'))
