...
// bitkincoin includes.
#include <..\src\script\bitkincoinconsensus.h>
...
int main()
{
    std::cout << "bitkincoinconsensus version: " << bitkincoinconsensus_version() << std::endl;
    ...
    auto op0Result = bitkincoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, bitkincoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
